...
db.on('populate', () => {
  ...
  db.skills.bulkPut([
    { name: "Python", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Back-End Languages', 'High-Level Languages'], experienceLevel: [] },
    { name: "JavaScript", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Front-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "TypeScript", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Front-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "Java", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "C#", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    ...
    { name: "C", category: ['Languages', 'Programming Languages', 'Back-End Languages', 'Low-Level Languages'], experienceLevel: [] },
    ...
    { name: "Kotlin", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    ...
    { name: "PowerShell", category: ["Languages", 'Scripting Languages',], experienceLevel: [] },
    { name: "Batch", category: ["Languages", 'Scripting Languages',], experienceLevel: [] },
    ...
    { name: "Scala", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages',], experienceLevel: [] },
    { name: "SWI-Prolog", category: ['Languages', 'Programming Languages',], experienceLevel: [] },
    ...
    { name: "Dart", category: ['Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
