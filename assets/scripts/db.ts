...
db.on('populate', () => {
  ...
  db.skills.bulkPut([
    { name: "Python", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Back-End Languages', 'High-Level Languages'], experienceLevel: [] },
    { name: "JavaScript", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Front-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "TypeScript", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Scripting Languages', 'Front-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "Java", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    { name: "C#", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    ...
    { name: "C", category: ['Procedural Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'Low-Level Languages'], experienceLevel: [] },
    ...
    { name: "MIPS", category: ['Languages', 'Programming Languages', 'Assembly Languages',], experienceLevel: [] },
    { name: "LMC", category: ['Languages', 'Programming Languages', 'Assembly Languages',], experienceLevel: [] },
    { name: "Kotlin", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
    ...
    { name: "Gleam", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages',], experienceLevel: [] },
    { name: "Haskell", category: ['Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages',], experienceLevel: [] },
    { name: "Scala", category: ['Object-Oriented Programming Languages', 'Functional Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages',], experienceLevel: [] },
    { name: "SWI-Prolog", category: ['Logic Programming Languages', 'Languages', 'Programming Languages',], experienceLevel: [] },
    ...
    { name: "Dart", category: ['Procedural Programming Languages', 'Object-Oriented Programming Languages', 'Languages', 'Programming Languages', 'Back-End Languages', 'High-Level Languages',], experienceLevel: [] },
