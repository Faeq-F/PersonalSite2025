...
<template>
  ...
  <Popover ref="settingsPopover" id="settingsPopover"
    ...
    <div class="flex flex-col gap-4">
      ...
      <div>
        <div class="flex items-center gap-2">
          ...
          <label for="zTheme" class="font-text"><span
              class="zTheme font-header">Zarlasht</span> theme</label>
        </div>
      </div>
    </div>
  </Popover>
...
<style>
html:not(.zTheme) #settingsPopover {
  border-style: solid;
...
html:not(.zTheme).dark #settingsPopover {
  background: #2d2d2d;
  border-style: solid;
